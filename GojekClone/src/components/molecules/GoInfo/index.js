        ...
        <View style={{ padding: 16, paddingBottom: 0 }}>
            ...
            <View style={{ flexDirection: 'row', marginBottom: 16 }}>
                ...
                <View style={{ marginLeft: 16, flex: 1 }}>
                    <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#4A4A4A' }}>Connect with Facebook</Text>
                    <Text style={{ fontSize: 16, fontWeight: 'normal', color: '#4A4A4A', width: '70%' }}>Login faster without verfication code</Text>
                </View>
            </View>
